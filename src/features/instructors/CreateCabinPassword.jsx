...
import { editCurrentUserA } from "../../services/apiAuth";
//k
function CreateCabinPassword({ cabinToEdit = {}, onCloseModal }) {
  ...
  const { isLoading: isEditing, mutate: editUser } = useMutation({
    mutationFn: ({ newData2 }) => editCurrentUserA(newData2),
    onSuccess: () => {
...
export default CreateCabinPassword;
